        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group mx-auto lg:ml-auto mt-12 lg:mt-0 perspective-1000" style={{ width: '280px' }}>
            ...
            >
              ...
              <div className="absolute inset-6 border border-white/5 rounded-[1.5rem] opacity-0 group-hover:opacity-100 scale-95 group-hover:scale-100 transition-all duration-1000 ease-out delay-100 pointer-events-none z-30"></div>
              
              <div className="absolute bottom-6 left-4 right-4 translate-y-10 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out delay-200 flex justify-center z-50">
                <Badge variant="secondary" className="bg-white/5 backdrop-blur-xl border border-white/10 text-[8px] uppercase tracking-widest px-4 py-1.5 shadow-2xl pointer-events-none text-white whitespace-nowrap">
